                      ...
                      children: [
                        ...
                        if (user?.role == UserRole.chef) ...[
                          _buildProfileInfo(
                            ...
                            user?.kitchenName.isNotEmpty == true
                                ? user!.kitchenName
                                : 'Private Kitchen',
                          ),
                        ...
                        onTap: () async {
                          ...
                          if (user != null) {
                            final selectedRole = await Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    RoleSelectionScreen(user: user),
                              ),
                            );

                            if (selectedRole != null &&
                                selectedRole is UserRole) {
                    ...
                    builder: (context, box, _) {
                      ...
                      return Container(
                        ...
                        child: SwitchListTile(
                          ...
                          subtitle: Text(
                            'Easy on the eyes, elegant design',
                            style: GoogleFonts.outfit(
                              fontSize: 12,
      ...
      children: [
        ...
        if (!isLast)
          Padding(
            ...
            child: Divider(
              height: 1,
              color: AppTheme.primaryGold.withValues(alpha: 0.03),
            ),
          ),
      ],
    );
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              trailing: ref.watch(localeProvider).languageCode == 'ur'
                  ? const Icon(Icons.check_circle, color: AppTheme.primaryGold)
                  : null,
              onTap: () {
      ...
      try {
        ...
        if (context.mounted) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Kitchen logo updated successfully! 🍳'),
            ),
          );
        }
      } catch (e) {
